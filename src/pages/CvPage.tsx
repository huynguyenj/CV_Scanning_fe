...
export default function CvPage() {
  ...
  return (
    <div className="bg-deep-cove rounded-md px-10 py-5">
        ...
        <div className="flex text-light-white">
          <Tabs variant='secondary'>
            <TabTrigger isSelect={tabValue == 'normal'} onSelect={setTabValue} content="Phân tích" value="normal"/>
            <TabTrigger isDisable={auth.accessToken ? false : true} isSelect={tabValue == 'advanced'}  onSelect={setTabValue} content="Phân tích nâng cao" value="advanced"/>
          </Tabs>
        </div>
